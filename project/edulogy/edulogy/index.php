...
<body>  
    ...
    <div id="wrapper">
        ...
        <header class="header">
            <!-- end topbar -->
            <?php require ('template/social.php'); ?>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            ...
                            <div class="blog-desc">
                                <h4><a href="blog-single.php">How to learn perfect code with Javascript</a></h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            ...
                            <div class="blog-desc">
                                <h4><a href="blog-single.php">The most suitable web design & development tutorials</a></h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            ...
                            <div class="blog-desc">
                                <h4><a href="blog-single.php">Design for all mobile devices! This is name "responsive"</a></h4>
